...
public class SethAnnotator extends JCasAnnotator_ImplBase {
    ...
    public void initialize(UimaContext context) throws ResourceInitializationException {
        ...
        // TODO: hack until resources get merged correctly
        URL url = SETH.class.getClassLoader().getResource("mutations.txt");
        File regex = new File(url.getFile());
        seth = new SETH(regex.getAbsolutePath(), useExactGrammar, useOldNomenclature);
    }
