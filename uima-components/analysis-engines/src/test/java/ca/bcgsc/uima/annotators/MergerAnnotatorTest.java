...
public class MergerAnnotatorTest {
    ...
    public void setUp() throws Exception {
        ...
        //todo: load type system file using uri, see PubMedCollectionReaderTest
    ...
    public void testProcess() throws Exception {
        ...
        FileInputStream in = new FileInputStream("annotator.properties");
