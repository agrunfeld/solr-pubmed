...
public class Section_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("types.Section");
  ...
  public String getLabel(int addr) {
      ...
      jcas.throwFeatMissing("label", "types.Section");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("content", "types.Section");
